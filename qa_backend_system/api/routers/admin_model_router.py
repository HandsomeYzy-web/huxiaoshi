...
async def list_model_providers(_user: User = Depends(require_permission("model.view"))):
...
async def activate_model_config(
    config_id: int = Path(...),
    db: Session = Depends(get_db),
    _user: User = Depends(require_permission("model.activate")),
):
...
async def delete_model_config(
    config_id: int = Path(...),
    db: Session = Depends(get_db),
    _user: User = Depends(require_permission("model.delete")),
):
